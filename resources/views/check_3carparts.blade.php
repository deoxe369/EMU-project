  ...
  <!--First Container-->
    ...
    <div class="bg-6 contain-carpart">
      ...
      <map name="tr3carparts">
        ...
        <area shape="rect" coords="399,170,700,330" href="#1stcar" onmouseover="writeText('- 1st car -')" onmouseout="writeText('')" alt="1st car">
        <area shape="rect" coords="701,170,999,330" href="#2ndcar" onmouseover="writeText('- 2nd car -')" onmouseout="writeText('')" alt="2nd car">
        <area shape="rect" coords="1000,170,1301,330" href="#3rdcar" onmouseover="writeText('- 3rd car -')" onmouseout="writeText('')" alt="3rdcar">
      </map>
