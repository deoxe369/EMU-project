...
<body data-spy="scroll">
  ...
  <!--First Container-->
    ...
    <div style="overflow-y: hidden; overflow-x: scroll; margin: 20px 2% 0 2%; background-color: #131617;">
      ...
      <img src="image/pic/train_4car_parts.png" usemap = "#locodetail" style="margin-top: 20px;">
      <map name="locodetail">
        <!-- loco coords -->
        ...
        <!-- 4th car coords -->
        <area shape="rect" coords="3322,418,3432,445" href="#4thcarBogies" onmouseover="writeText('4th car Bogies')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Bogies">
        <area shape="rect" coords="3358,468,3469,496" href="#4thcarBattery" onmouseover="writeText('4th car Battery')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Battery">
        <area shape="rect" coords="3480,507,3616,535" href="#4thcarSteamVaporTraps" onmouseover="writeText('4th car Steam Vapor Traps')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Steam Vapor Traps">
        <area shape="rect" coords="3605,451,3714,478" href="#4thcarBrakeSet" onmouseover="writeText('4th car Brake Set')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Brake Set">
        <area shape="rect" coords="3738,451,3848,479" href="#4thcarWheels" onmouseover="writeText('4th car Wheels')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Wheels">
        <area shape="rect" coords="3804,404,3914,432" href="#4thcarSteelStep" onmouseover="writeText('4th car Steel Step')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Steel Step">
        <area shape="rect" coords="3738,497,3913,525" href="#4thcarSteamEndConnection" onmouseover="writeText('4th car Steam End Connection')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Steam End Connection">
        <area shape="rect" coords="3712,126,3887,153" href="#4thcarSaftyTailGates" onmouseover="writeText('4th car Safty Tail Gates')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Safty Tail Gates">
        <area shape="rect" coords="3642,73,3751,101" href="#4thcarRoof" onmouseover="writeText('4th car Roof')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Roof">
        <area shape="rect" coords="3551,120,3659,147" href="#4thcarWindows" onmouseover="writeText('4th car Windows')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Windows">
        <area shape="rect" coords="3387,89,3496,117" href="#4thcarTumblehome" onmouseover="writeText('4th car Tumblehome')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Tumblehome">
        <area shape="rect" coords="3238,149,3348,177" href="#4thcarDoors" onmouseover="writeText('4th car Doors')" onmouseout="writeText('ตรวจสภาพอะไหล่')" alt="4th car Doors">
